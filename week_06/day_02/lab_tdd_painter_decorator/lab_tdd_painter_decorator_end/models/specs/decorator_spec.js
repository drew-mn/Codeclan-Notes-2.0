...
describe('Decorator', function () {
  ...
  it('should start with an empty paint stock', function () {
    const expected = [];
    assert.deepStrictEqual(expected, decorator.paintStock);
  });
  ...
  it('should be able to calculate total litres paint it has in stock', function () {
    ...
    const expected = 15;
    decorator.calculateAmountOfPaint();
  });
  ...
  it('should be able to calculate that it has enough paint to paint a room', function () {
    ...
    const expected = true;
    assert.deepStrictEqual(expected, decorator.hasEnoughPaint(room));
  });
  ...
  it('should be able to decrease amount of paint in stock for a given room', function () {
    ...
    const expected = 0;
    assert.strictEqual(expected, decorator.calculateAmountOfPaint());
  });
